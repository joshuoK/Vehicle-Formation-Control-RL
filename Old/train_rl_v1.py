...
-----------
    ...
    python train_rl_v1.py --mode train
    python train_rl_v1.py --mode eval
    python train_rl_v1.py --mode both
"""
...
class SARGymnasiumWrapper(gym.Env):
    ...
    def render(self) -> None:
        ...
        self._fig.suptitle(
            f'SAR Swarm [RL+APF v1]  t={self._env.t:.1f}s',
...
def train() -> None:
    print("=" * 60)
    print("  SAR SWARM  —  PPO  v1  (Hybrid APF + fixed termination)")
    print("=" * 60)
    ...
    callbacks = [
        ...
        CheckpointCallback(
            ...
            save_path=CHECKPOINT_DIR, name_prefix="ppo_sar_v1", verbose=1,
        ),
    ]
    ...
    model.learn(
        ...
        progress_bar=True, reset_num_timesteps=True, tb_log_name="PPO_SAR_v1",
    )
